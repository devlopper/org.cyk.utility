...
public interface ByDimensionOneIdentifierQuerier<ENTITY,DIMENSION,DIMENSION_IDENTIFIER> {
	...
	default Collection<DIMENSION_IDENTIFIER> getIdentifiers(Collection<DIMENSION> dimensions) {
		...
		Collection<DIMENSION_IDENTIFIER> identifiers = (Collection<DIMENSION_IDENTIFIER>) (ValueUsageType.SYSTEM.equals(getIdentifierValueUsageType()) ?
				FieldHelper.readSystemIdentifiers(dimensions) : FieldHelper.readBusinessIdentifier(dimensions)); 
	...
	Collection<ENTITY> readByIdentifiers(Collection<DIMENSION_IDENTIFIER> identifiers,Arguments arguments);
	...
	default Collection<ENTITY> readByIdentifiers(Arguments arguments,DIMENSION_IDENTIFIER...identifiers) {
	...
	Long countByIdentifiers(Collection<DIMENSION_IDENTIFIER> identifiers,Arguments arguments);
	...
	default Long countByIdentifiers(Arguments arguments,DIMENSION_IDENTIFIER...identifiers) {
		if(ArrayHelper.isEmpty(identifiers))
			return null;
