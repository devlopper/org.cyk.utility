 ...
 * @param <ELEMENT>
 */
public interface Collectionable<ELEMENT> extends Objectable {
	...
	default Collectionable<ELEMENT> setElementClass(Class<ELEMENT> elementClass) {
	...
	default ELEMENT instantiateElement() {
		...
		if(elementClass == null)
			setElementClass(elementClass = (Class<ELEMENT>) ClassHelper.getByName(StringUtils.substringBeforeLast(getClass().getName(), Collectionable.class.getSimpleName())));
	...
	default Collectionable<ELEMENT> setElements(java.util.Collection<ELEMENT> elements) {
		FieldHelper.write(this, PROPERTY_ELEMENTS, elements);
		return this;
	}
	
	default Collectionable<ELEMENT> add(java.util.Collection<ELEMENT> elements) {
	...
	default Collectionable<ELEMENT> add(@SuppressWarnings("unchecked") ELEMENT...elements) {
