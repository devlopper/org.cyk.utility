...
public class ValueConverterUnitTest extends AbstractWeldUnitTest {
	...
	@Test
	public void convert_utilDate_to_localDateTime() {
		LocalDateTime localDateTime = convert(Date.from(LocalDateTime.of(2020,05,10,11,30).toInstant(ZoneOffset.UTC)), LocalDateTime.class);
		assertThat(localDateTime).isNotNull();
		assertThat(localDateTime.getYear()).isEqualTo(2020);
	}
	
	@Test
	public void convert_localDateTime_to_utilDate() {
		Date date = convert(LocalDateTime.of(2020,05,10,11,30), Date.class);
