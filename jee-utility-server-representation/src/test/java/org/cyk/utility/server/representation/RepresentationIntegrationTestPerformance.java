...
public class RepresentationIntegrationTestPerformance extends AbstractRepresentationArquillianIntegrationTestWithDefaultDeployment {
	...
	protected void __listenBeforeCallCountIsZero__() throws Exception {
		...
		DependencyInjection.setQualifierClass(InstanceBuilder.class, org.cyk.utility.__kernel__.annotation.Test.Class.class);
		//AbstractPersistenceFunctionImpl.LOG_LEVEL = LogLevel.INFO;
		//AbstractBusinessFunctionImpl.LOG_LEVEL = LogLevel.INFO;
		RepresentationFunctionReaderImpl.LOG_LEVEL = LogLevel.INFO;
	}
