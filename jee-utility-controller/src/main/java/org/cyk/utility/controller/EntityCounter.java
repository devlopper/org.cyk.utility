...
public interface EntityCounter {
	...
	public abstract static class AbstractImpl extends AbstractObject implements EntityCounter,Serializable {
		...
		public <ENTITY> Long count(Class<ENTITY> controllerEntityClass,Arguments<ENTITY> arguments) {
			...
			arguments.prepare(controllerEntityClass, org.cyk.utility.representation.EntityCounter.class);
			Response response = ((org.cyk.utility.representation.EntityCounter)arguments.__representation__).count(arguments.__representationArguments__);
