...
public interface EntitySaver {
	...
	public static abstract class AbstractImpl extends AbstractObject implements EntitySaver,Serializable {
		...
		protected <T> void prepare(Class<T> controllerEntityClass, Arguments<T> arguments) {
			arguments.prepare(controllerEntityClass, org.cyk.utility.representation.EntitySaver.class);
		}
		...
		protected <T> Response save(Object representation,Collection<?> creatables,Collection<?> updatables,Collection<?> deletables,org.cyk.utility.representation.Arguments arguments) {
			return ((org.cyk.utility.representation.EntitySaver<Object>)representation)
