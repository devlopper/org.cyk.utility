package org.cyk.utility.client.controller.web.jsf.primefaces.playground;
...
public class CommandPage extends AbstractPageImpl implements Serializable {
	...
	protected void __listenPostConstruct__() {
		...
		execution.getProperties().setRunnable(new Runnable() {
			...
			@Override
			public void run() {
				System.out.println("CommandPage.__listenPostConstruct__().new Runnable() {...}.run() V002 NW");
	...
	public void executeCommandSimple() {
		System.out.println("CommandPage.executeCommandSimple()");
	}
}
