...
public interface DataTransferObjectProcessor {
	...
	<T> void process(Class<T> klass,Arguments arguments,Action action,T...array);
	
	<T> void processRead(Class<T> klass,Arguments arguments,Collection<T> collection);
	<T> void processRead(Class<T> klass,Arguments arguments,T...array);
	...
	public abstract static class AbstractImpl extends AbstractObject implements DataTransferObjectProcessor,Serializable {
		...
		@Override
		public <T> void process(Class<T> klass,Arguments arguments,Action action, T... array) {
		...
		@Override
		public <T> void processRead(Class<T> klass,Arguments arguments, T... array) {
