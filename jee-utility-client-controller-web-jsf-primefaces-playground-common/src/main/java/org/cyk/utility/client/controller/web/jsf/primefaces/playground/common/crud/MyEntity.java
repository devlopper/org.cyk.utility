...
public interface MyEntity extends Data {
	...
	/**/
	/*
	Collection<MyEntityData> COLLECTION = DependencyInjection.inject(CollectionHelper.class).instanciate(
			DependencyInjection.inject(MyEntityData.class).setCode("C01").setName("Name01").setDescription("Line0101\n\rLine0102")
			,DependencyInjection.inject(MyEntityData.class).setCode("C02").setName("Name02").setDescription("Line0201\n\rLine0202")
			,DependencyInjection.inject(MyEntityData.class).setCode("C03").setName("Name03").setDescription("Line0301\n\rLine0302")
			);
	*/
