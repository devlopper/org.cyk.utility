...
import org.cyk.utility.stream.distributed.kafka.AbstractMessageDeserializer;

public class MessageDeserializer extends AbstractMessageDeserializer<FunctionExecutionMessage> implements Serializable {
