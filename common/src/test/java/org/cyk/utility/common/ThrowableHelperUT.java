...
public class ThrowableHelperUT extends AbstractUnitTest {
	...
	@Test
	public void throw_(){
		new ThrowableHelper().throw_(new ThrowableHelper.Throwable.Builder.Adapter.Default<RuntimeException>(RuntimeException.class)
				.addManyParameters("message1","message2","another message again","one more...").execute());
	}
