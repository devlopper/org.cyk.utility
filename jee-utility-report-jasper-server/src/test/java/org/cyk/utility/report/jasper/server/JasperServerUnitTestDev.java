...
public class JasperServerUnitTestDev extends AbstractWeldUnitTest {
	...
	public void t(){
		...
		String uri = "/reports/sigobe/acteur/FicheGestCredit";
		Map<Object,Object> parameters = Map.of("identifiant","c8997833-258f-4d83-8084-54975ad90a22");
		try {
			FileUtils.writeByteArrayToFile(new File("target/demande_fonctions.pdf"), ReportGetter.getInstance().get(uri,parameters,FileType.PDF).toByteArray(), Boolean.FALSE);
