...
public interface Service {
	...
	String PARAMETER_NAME_DEFAULTABLE = "df";
	String PARAMETER_NAME_DEFAULTABLE_DESCRIPTION = "Default value";
	String PARAMETER_NAME_DEFAULTABLE_DESCRIPTION_FRENCH = "Valeur par défaut";
