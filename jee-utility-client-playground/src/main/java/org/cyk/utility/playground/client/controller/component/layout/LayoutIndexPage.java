...
public class LayoutIndexPage extends AbstractPageContainerManagedImpl implements Serializable {
	...
	protected void __listenPostConstruct__() {
		...
		layoutOneColumn = Builder.build(Layout.class,Map.of(Layout.FIELD_IDENTIFIER,"layoutOneColumn",Layout.FIELD_CELL_WIDTH_UNIT,Cell.WidthUnit.UI_G,Layout.FIELD_NUMBER_OF_COLUMNS,1
		...
		layoutTwoColumns = Builder.build(Layout.class,Map.of(Layout.FIELD_IDENTIFIER,"layoutTwoColumns",Layout.FIELD_CELL_WIDTH_UNIT,Cell.WidthUnit.UI_G,Layout.FIELD_NUMBER_OF_COLUMNS,2
		...
		layoutThreeColumns = Builder.build(Layout.class,Map.of(Layout.FIELD_IDENTIFIER,"layoutThreeColumns",Layout.FIELD_CELL_WIDTH_UNIT,Cell.WidthUnit.UI_G,Layout.FIELD_NUMBER_OF_COLUMNS,3
		...
		layoutComplex = Builder.build(Layout.class,Map.of(Layout.FIELD_IDENTIFIER,"layoutComplex",Layout.FIELD_CELL_WIDTH_UNIT,Cell.WidthUnit.UI_G
				,Layout.ConfiguratorImpl.FIELD_CELLS_MAPS,CollectionHelper.listOf(
