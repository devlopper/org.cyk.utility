...
import org.cyk.utility.client.controller.web.jsf.primefaces.model.collection.DataTableEntity;
import org.cyk.utility.client.controller.web.jsf.primefaces.model.collection.DataTableEntityBuilder;
...
public class CollectionDataTablePage extends AbstractPageContainerManagedImpl implements Serializable {
	...
	protected void __listenPostConstruct__() {
		...
		dataTable = DataTableEntityBuilder.build(Namable.class, DataTableEntity.ActionMode.INLINE);
